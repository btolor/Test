 ...
 * grade, class avg, and class grade. The Tests
 ...
 Tests class will also store each Tests class object
...
public class Tests {
    ...
    /**
     * These variables are for the entire students' class,
    ...
    public double calculateTestAvg(){
        ...
        setAvg(gradeAvg);
        setlGrade(calculateLetterGrade(gradeAvg));
     ...
     * */
    public String calculateLetterGrade(double gAvg){
        String letter ="";
        double grade = gAvg;
        if(grade >= 90){
            letter = "A";
